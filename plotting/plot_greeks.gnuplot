...
# Set terminal to display on screen (can be changed to png, pdf, etc.)
set terminal qt size 1400,1000 font "Arial,10"
...
pause -1 "Press Enter to continue to Scenario 2..."
